...
using TechnicalService.Portal.Managment.Constants;
...
namespace TechnicalService.Portal.Managment.Pages.Profile
{
    public partial class ChangePassword : ComponentBase
    {
        ...
        private void NavigateBack() => NavigationManager.NavigateTo(ManagmentRouteConstants.Profile);
