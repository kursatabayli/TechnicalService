...
{
    public partial class MyServiceRecordsList : ComponentBase
    {
        private List<ServiceRecordListDto> _serviceRecords = [];
        private bool _isLoading = true;
        private string _searchText = string.Empty;

        [Inject] private IDataService<Result<List<ServiceRecordListDto>>> GetPersonnelServiceRecords { get; set; }
        ...
        {
            _isLoading = true;
            var result = await GetPersonnelServiceRecords.GetAsync(Endpoints.GetServiceRecordsByPersonnelId, ClientTypes.PersonnelAuthClient);
