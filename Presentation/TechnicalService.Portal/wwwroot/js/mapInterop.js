...
//const addressLines = [Address, `${District} / ${City}`, PostalCode && `Posta Kodu: ${PostalCode}`].filter(Boolean);
//const copyAddress = [Address, `${District} / ${City}`, PostalCode];
...
//                                <button onclick="navigator.clipboard.writeText('${copyAddress}')"
//                                        class="mud-button mud-button-text mud-button-icon-size-medium mud-button-variant-text"
