...
namespace TechnicalService.Portal.Admin.Pages.ServiceRecords
{
    public partial class ServiceRecordsList : ComponentBase
    {
        ...
        [Inject] private IDataService<Result<List<ServiceRecordListDto>>> GetAllServiceRecords { get; set; }
        ...
        {
            _isLoading = true;
            var result = await GetAllServiceRecords.GetAsync(Endpoints.GetAllServiceRecords, ClientTypes.PersonnelAuthClient);
