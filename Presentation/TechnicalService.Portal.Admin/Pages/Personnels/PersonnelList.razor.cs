...
namespace TechnicalService.Portal.Admin.Pages.Personnels
{
    public partial class PersonnelList : ComponentBase
    {
        ...
        {
            var personnels = await GetPersonnelDataService.GetAsync(Endpoints.GetAllPersonnels, ClientTypes.PersonnelAuthClient);
        ...
        private IEnumerable<PersonnelDto> FilteredRequests =>
            SearchService.Search(SearchText, dto, b => [$"{b.Name} {b.Surname}", b.ServiceName, b.Email]) ?? [];
